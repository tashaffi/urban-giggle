...
int main() {
    ...
    while(1){
         // Accept a also I should keep track of the connection
        ...
        if (pid == 0) {  // Child process
            ...
            if (status_code == 1) {
                printf("Congratulations! The script from Process ID %d is safe to execute!\n", getpid());
                ...
                printf("NO valid certificate found for the script received from Process ID %d! Do not execute!\n", getpid());
            }
